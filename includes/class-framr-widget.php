...
class Framr_Widget extends WP_Widget {
     ...
     * @var      string
     */
    protected $widget_slug = 'framr-widget';
	...
	public function __construct() {
		...
		parent::__construct(
			...
			__( 'Framr Widget', $this->get_widget_slug() ),
			array(
				'classname'  => $this->get_widget_slug().'-class',
				'description' => __( 'use this to place the frame calculator.', $this->get_widget_slug() )
			)
		);
