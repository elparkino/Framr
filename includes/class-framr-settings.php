...
class Framr_Settings {

	/**
	 * The single instance of Framr_Settings.
	 * @var 	object
	 * @access  private
	 * @since 	1.0.0
	 */
	...
	public function add_settings_link ( $links ) {
		$settings_link = '<a href="options-general.php?page=' . $this->parent->_token . '_settings">' . __( 'Settings', 'framr' ) . '</a>';
	...
	private function settings_fields () {
		...
		$settings['Gallery'] = array(
			...
			'fields'				=> array(
				array(
					'id' 			=> 'number_field',
					'label'			=> __( 'A Number' , 'framr' ),
					'description'	=> __( 'This is a standard number field - if this field contains anything other than numbers then the form will not be submitted.', 'framr' ),
					'type'			=> 'number',
					'default'		=> '',
					'placeholder'	=> __( '42', 'framr' )
				),
				array(
					'id' 			=> 'colour_picker',
					'label'			=> __( 'Pick a colour', 'framr' ),
					'description'	=> __( 'This uses WordPress\' built-in colour picker - the option is stored as the colour\'s hex code.', 'framr' ),
					'type'			=> 'color',
					'default'		=> '#21759B'
				),
				array(
					'id' 			=> 'an_image',
					'label'			=> __( 'An Image' , 'framr' ),
					'description'	=> __( 'This will upload an image to your media library and store the attachment ID in the option field. Once you have uploaded an imge the thumbnail will display above these buttons.', 'framr' ),
					'type'			=> 'image',
					'default'		=> '',
					'placeholder'	=> ''
				),
				array(
					'id' 			=> 'multi_select_box',
					'label'			=> __( 'A Multi-Select Box', 'framr' ),
					'description'	=> __( 'A standard multi-select box - the saved data is stored as an array.', 'framr' ),
					'type'			=> 'select_multi',
	...
	public function settings_page () {
		...
		$html = '<div class="wrap" id="' . $this->parent->_token . '_settings">' . "\n";
			$html .= '<h2>' . __( 'Plugin Settings' , 'framr' ) . '</h2>' . "\n";
			...
			$html .= '<form method="post" action="options.php" enctype="multipart/form-data">' . "\n";
				...
				$html .= '<p class="submit">' . "\n";
					...
					$html .= '<input name="Submit" type="submit" class="button-primary" value="' . esc_attr( __( 'Save Settings' , 'framr' ) ) . '" />' . "\n";
				$html .= '</p>' . "\n";
			$html .= '</form>' . "\n";
		$html .= '</div>' . "\n";
	...
	/**
	 * Main Framr_Settings Instance
	 *
	 * Ensures only one instance of Framr_Settings is loaded or can be loaded.
	 *
	 * @since 1.0.0
	 * @static
	 * @see Framr()
	 * @return Main Framr_Settings instance
	 */
